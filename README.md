...
### PDF con nombres largos
El lector reconstruye productos cuando el nombre ocupa varias líneas y la cantidad aparece en una línea separada. El nombre se conserva en una sola casilla y puede mostrarse con salto de línea en Packing List y Factura Comercial.
